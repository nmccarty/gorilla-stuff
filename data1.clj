...
;; @@
;; =>
;;; {"type":"html","content":"<span class='clj-unkown'>274</span>","value":"274"}
;; <=
...
;; @@
;; =>
;;; {"type":"list-like","open":"<span class='clj-lazy-seq'>(</span>","close":"<span class='clj-lazy-seq'>)</span>","separator":" ","items":[{"type":"html","content":"<span class='clj-long'>152065</span>","value":"152065"},{"type":"html","content":"<span class='clj-long'>815</span>","value":"815"},{"type":"html","content":"<span class='clj-long'>1707</span>","value":"1707"},{"type":"html","content":"<span class='clj-long'>790</span>","value":"790"},{"type":"html","content":"<span class='clj-long'>9954364</span>","value":"9954364"},{"type":"html","content":"<span class='clj-long'>3275</span>","value":"3275"},{"type":"html","content":"<span class='clj-long'>7890</span>","value":"7890"},{"type":"html","content":"<span class='clj-long'>175613</span>","value":"175613"},{"type":"html","content":"<span class='clj-long'>223465</span>","value":"223465"},{"type":"html","content":"<span class='clj-long'>540817</span>","value":"540817"}],"value":"(152065 815 1707 790 9954364 3275 7890 175613 223465 540817)"}
;; <=
...
;; @@
;; =>
;;; {"type":"html","content":"<span class='clj-long'>9954364</span>","value":"9954364"}
;; <=
...
(defn normalize [coll]
  (let [coll-sum (reduce + coll)
        scale       (/ coll-sum)]
    (map #(* % scale)
         coll)))

;; Another helper function
(defn element-wise-combine [operator coll1 coll2]
  (if (or (empty? coll1)
          (empty? coll2))
    '()
    (lazy-seq
     (cons (operator (first coll1)
                     (first coll2))
           (element-wise-combine operator
                                 (rest coll1)
                                 (rest coll2))))))

;; Takes the actual weighted average
(defn weighted-average [coll]
  (let [freq-map      (frequencies coll)
        mode                 (mode coll)
        freq-mode        (freq-map mode)
        count-coll          (count coll)
        weights    (map #(/ (freq-map %)
                            freq-mode)
                        coll)
        weights      (normalize weights)]
    (->> coll
         (element-wise-combine * weights)
         (reduce +)
         (double))))
;; @@
;; =>
;;; {"type":"html","content":"<span class='clj-var'>#&#x27;economy-health/weighted-average</span>","value":"#'economy-health/weighted-average"}
;; <=
...
(def rounded-monies 
  (map rounding-fun monies))

(println "Average:")
(println (format "%.2f" 
                 (average rounded-monies)))
(println)
(println "Weighed Average:")
(println (format "%.2f" 
                 (weighted-average rounded-monies)))
(println)
(println "Mode:")
(println (format "%.2f" 
                 (double (mode rounded-monies))))
(println)
